...
(function() {
	...
	var x, z = document,
		...
		Jb = {}, ub = 0,
		Za, O, cb, Oa, vb, D, Ca = function() {}, ia = "div",
		T = "none",
	...
	va.prototype = {
		...
		getBBox: function() {
			...
			if (!a) {
				...
				} else a = this.htmlGetBBox(); if (b.isSVG && (b = a.width, c = a.height, d)) a.width = N(c * aa(e)) + N(b * W(e)), a.height = N(c * W(e)) + N(b * aa(e));
				this.bBox = a
			}
			return a
		},
	...
	ra.prototype = {
		...
		buildText: function(a) {
			...
			n(c, function(c, d) {
				...
				n(h, function(c) {
					if (c !== "" || h.length === 1) {
						var m = {}, p = z.createElementNS("http://www.w3.org/2000/svg", "tspan");
	...
	Pa.prototype = {
		...
		render: function(a, b) {
			...
			if (h && !isNaN(Q)) h.xy = J = this.getLabelPosition(Q, J, h, f, j, I, a, t), this.isFirst && !p(d.showFirstLabel, 1) || this.isLast && !p(d.showLastLabel, 1) ? w = !1 : !v && f && j.overflow === "justify" && !this.handleOverflow(a, J) && (w = !1), t && a % t && (w = !1), w ? (h[this.isNew ? "attr" : "animate"](J), h.show(), this.isNew = !1) : h.hide()
		},
		destroy: function() {
			Aa(this, this.axis)
		}
	...
	ob.prototype = {
			...
			n(a.series, function(g) {
				if (g.visible || !b.options.chart.ignoreHiddenSeries) {
					...
					if (a.isXAxis) {
						...
						if (a.dataMax < y) a.dataMax = y, a.ignoreMaxPadding = !0
					}
				}
			})
		},
		...
		getOffset: function() {
			...
			if (b || a.isLinked) n(e, function(b) {
				...
				for (y in f) f[y].destroy(), delete f[y]; if (m && m.text) {
	...
	sb.prototype = {
		...
		getMargins: function() {
			...
			this.resetMargins();
			e = this.axisOffset;
			if ((this.title || this.subtitle) && !u(this.optionsMarginTop))
